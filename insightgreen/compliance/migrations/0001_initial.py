# Generated by Django 5.1.2 on 2025-07-15 20:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_year', models.IntegerField(choices=[(2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022), (2023, 2023), (2024, 2024), (2025, 2025)], default=2025)),
                ('reporting_period', models.CharField(choices=[('Annual', 'Annual Report'), ('Quarterly', 'Quarterly Report'), ('Periodic', 'Periodic Updates')], max_length=100)),
                ('standards_applied', models.TextField()),
                ('report_type', models.CharField(choices=[('Sustainability', 'Sustainability Report'), ('Integrated', 'Integrated Report'), ('Climate', 'Climate Report'), ('Annual', 'Annual Report'), ('Financial and ESG', 'Financial and ESG Report'), ('Other', 'Other')], default='Annual', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('report', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='extracted_pages', to='compliance.esgreport')),
            ],
            options={
